...
<h1>Administración de Unidad de Producci&oacute;n</h1>
...
<form action="" method="post">
  ...
  <legend> Filtro </legend>
    ...
    <p>  
      ...
      <p>
      <label> Cliente </label> <input name="fdescripcion" type="text" />
      </p>
      <p>
      <label> Turno </label> <input name="fdescripcion" type="text" />
      </p>
      <p>
